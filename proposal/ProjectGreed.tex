...
This will be taken over longer perioes of time (multiple years), rather than over a few days
as might be seen in high-frequency trading.

For testing the algorithms, we plan to build our own simple backtesting framwork using Python,
